...
public class JsonicServlet extends HttpServlet {
	private static final long serialVersionUID = 4043920189634748412L;
	...
	protected Object getComponent(String path) throws Exception {
		return SingletonS2Container.getComponent(path);
	}
